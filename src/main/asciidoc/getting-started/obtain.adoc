...
image::../images/SyncopeLayoutInK8s.png[]
...
image::../images/netbeans01.png[netbeans01]

Click on `Downloaded > Add Plugins...`:

image::../images/netbeans02.png[netbeans02]

image::../images/netbeans03.png[netbeans03]

image::../images/netbeans04.png[netbeans04]

Select `Apache Syncope Netbeans IDE Plugin` and click on `Install`:

image::../images/netbeans05.png[netbeans05]

image::../images/netbeans06.png[netbeans06]

==== Setup

Once installed go to `Window` > `Apache Syncope`:

image::../images/netbeans07.png[netbeans07]

The first time the plugin is run, it will prompt for connection details:

image::../images/netbeans12.png[netbeans12]
...
image::../images/netbeans11.png[netbeans11]
